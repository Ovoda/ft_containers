...
main (void)
{
  ...
  /* Testing constructor */
  NS::vector<int> _v_default0;
  NS::vector<int> _v_default1 (_alloc);
  NS::vector<int> _v_fill0 (10, 42);
  NS::vector<int> _v_fill1 (10, 42, _alloc);
  NS::vector<int> _v_range0 (_v_fill0.begin (), _v_fill0.end ());
  NS::vector<int> _v_range1 (_v_fill0.begin (), _v_fill0.end (),
                           _v_fill0.get_allocator ());
  NS::vector<int>::const_iterator _cbegin = _v_range0.begin();
  NS::vector<int>::const_iterator _cend = _v_range0.end();
  const NS::vector<int> _v_range2 (_cbegin, _cend);

  NS::vector<int> _v_copy (_v_fill0);
